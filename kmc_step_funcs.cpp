...
void KMC_U(const ProteinData &pData, const int Npj,
    ...
    // Create KMC objects
    KMC<SylinderNearEP> kmc_end0(pData.bind.pos, Npj, rcut01);
    KMC<SylinderNearEP> kmc_end1(pData.bind.pos, Npj, rcut01);
...
void KMC_S(const ProteinData &pData, const int Npj,
    ...
    KMC<SylinderNearEP> kmc_unbind(pData.bind.posEndBind[head_bound]);
    KMC<SylinderNearEP> kmc_bind(pData.bind.posEndBind[head_bound], Npj,
                                 pData.getRcutSD(), pType->LUTablePtr);
...
void KMC_D(const ProteinData &pData, const int Npj,
    ...
    KMC<SylinderNearEP> kmc_UB0(pData.bind.posEndBind[0]);
    KMC<SylinderNearEP> kmc_UB1(pData.bind.posEndBind[1]);
