...
class Sylinder {
  public:
    ...
    int globalIndex =
        GEO_INVALID_INDEX;  ///< unique global index sequentially ordered
    int rank = -1;          ///< mpi rank
    ...
    double
        sepmin; ///< minimal separation with its neighbors within radiusSearch

    double pos[3];         ///< position
    double orientation[4]; ///< orientation quaternion. direction norm vector =
                           ///< orientation * (0,0,1)
    ...
    double velNonB[3];    ///< all non-Brownian deterministic velocity beforce
                          ///< collision resolution
    double omegaNonB[3];  ///< all non-Brownian deterministic angular velocity
     ...
     * vtp/vtu file
     *
     * @tparam Container container for local sylinders which supports []
     * operator
     * @param sylinder
    ...
    //    static void writeVTP(const Container &sylinder, const int
    //    sylinderNumber,
    ...
    //                                sylinderNumber); // position always in
    //                                Float64
    ...
    //            in line offset[i] =
    //                2 * i +
    //                2; // offset is the end of each line. in fortran indexing
    ...
    //        IOHelper::writeDataArrayBase64(radiusCollision, "radiusCollision",
    //        1,
    //                                       file);
    //        IOHelper::writeDataArrayBase64(length, "length", 1, file);
    //        IOHelper::writeDataArrayBase64(lengthCollision, "lengthCollision",
    //        1,
    //                                       file);
    //        IOHelper::writeDataArrayBase64(vel, "velocity", 3, file);
    //        IOHelper::writeDataArrayBase64(omega, "omega", 3, file);
    //        IOHelper::writeDataArrayBase64(velBrown, "velocityBrown", 3,
    //        file); IOHelper::writeDataArrayBase64(omegaBrown, "omegaBrown", 3,
    //        file); IOHelper::writeDataArrayBase64(velCol, "velocityCollision",
    //        3, file); IOHelper::writeDataArrayBase64(omegaCol,
    //        "omegaCollision", 3, file);
